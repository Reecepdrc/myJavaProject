...
public class ArabaRunner {
    ...
    public static void main(String[] args) {
         ...
         */
        r2_constraktor.Araba araba1=new r2_constraktor.Araba();
        araba1.fiyat=10000;
         ...
         */
        r2_constraktor.Araba araba2=new r2_constraktor.Araba("BMW","5.20",2011,15000);
        System.out.println("Araba2 bilgileri\nMarka : " + araba2.marka +"\nModel : " + araba2.model
                +"\nYil : " + araba2.yil+ "\nFiyat : " + araba2.fiyat);
        r2_constraktor.Araba araba3=new r2_constraktor.Araba("Opel","Astra",2015,78000);
        System.out.println("Araba3 bilgileri\nMarka : " + araba3.marka +"\nModel : " + araba3.model
                +"\nYil : " + araba3.yil+ "\nFiyat : " + araba3.fiyat);
        r2_constraktor.Araba araba4=new r2_constraktor.Araba("Audi","A5",2020,50000);
